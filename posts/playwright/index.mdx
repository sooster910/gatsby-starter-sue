---
title: Playwright으로 E2E 테스트 자동화 -1
slug: playwright
author: Hyunsu Joo
...
하지만 Playwright의 기본적 철학에 근거한 E2E 테스팅을 위한 툴로써 Playwright Test라는 테스트 러너를 지원하며 다른 외부의 자바스크립트 테스트 러너와 함께 사용이 가능합니다.
...
<img src="../images/context.png" alt="context" max-width="380px" />
