...
draft: false
image: ./browserTesting.png
imageAlt: robot
tags: ['Testing']
---

이 글은 제가 최근에 시작한 테스트 프로젝트에 playwright를 사용하게 되면서 브라우저 테스팅과 puppeteer, playwright, selenium 에 대하여 적어보았습니다.  
잘못된 정보를 담고 있다면 꼭 알려주시면 감사하겠습니다.
...
<img src="../images/protocol.png" alt="protocol" max-width="600px" />
